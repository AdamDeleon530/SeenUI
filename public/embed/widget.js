...
(function () {
  ...
  function buildCSS(embed) {
    ...
    return [
      ...
      '.lbe-cal-nav { width: 28px; height: 28px; border: none; background: none; cursor: pointer; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: #6b7280; transition: background 0.15s; padding: 0; }',
      '.lbe-cal-nav:hover { background: #f3f4f6; color: ' + textColor + '; }',
      ...
      '.lbe-cal-day { width: 100%; aspect-ratio: 1; border: none; background: none; border-radius: 6px; font-size: 13px; cursor: pointer; color: ' + textColor + '; transition: background 0.1s; display: flex; align-items: center; justify-content: center; font-family: inherit; padding: 0; }',
      '.lbe-cal-day:hover:not(:disabled) { background: #f3f4f6; }',
      '.lbe-cal-day:disabled { color: #d1d5db; cursor: not-allowed; }',
      ...
      '.lbe-cal-day.other-month { color: #d1d5db; }',
